...
function saveProgress() {
  localStorage.setItem("canSxp", xp);
  localStorage.setItem("canSlevel", level);
}

function loadProgress() {
  const savedXP = localStorage.getItem("canSxp");
  const savedLevel = localStorage.getItem("canSlevel");
