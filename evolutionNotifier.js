...
(function () {
  ...
  const QUIZ_KEYS = [
    "monthsSlevelr", "monthsMlevelr",
    "subjectSlevelr", "subjectsMlevelr",
    "eventSlevelr", "eventMlevelr",
    "familySlevelr", "familyMlevelr",
    "characterSlevelr", "characterMlevelr",
    "canSlevelr", "canMlevelr",
    "jobsSlevelr", "jobsMlevelr",
  ...
  function showEvolutionToast() {
    if (document.getElementById("evolutionToast")) return;
